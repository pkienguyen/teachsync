...
<body>
    ...
    if ($result->num_rows > 0) {
                    ...
                    $role = $row["role"];
                    if ($role != 1){
                        header("Location: /myapp/TeachSync/giangvien/trangchu.php");
                    }
                }
    ?> 
    ...
    <header>
        ...
        <div class="settings" id="settings">
            <ul>
                <a href="#"><li><img src='../assets/profile.png'><strong> Thông tin cá nhân</strong></li></a>
                <a href="#"><li>Liên kết tài khoản</li></a>
                <a href="#"><li>Đổi mật khẩu</li></a>               
                <a href="#"><li style="border-top: 1px solid #4a4c5d">
                    <img src='../assets/setting.png'><strong> Cài đặt</strong></li></a>
                ...
                <a onclick="return confirm('Xác nhận đăng xuất?');" href="../dangxuat.php">
                    <li style="border-top: 1px solid #4a4c5d"><img src='../assets/logout.png'><strong> Đăng xuất</strong></li></a>
            </ul>
        </div>
    ...
    <div class="container">
        <img class="bgr" src="../assets/trangchu.png">
