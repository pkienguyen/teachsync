...
<header>
    ...
    <div class="menu">
        ...
        <a href="../qlgiangvien/dsgiangvien.php"><img src="../../assets/lecturer.png"> Thông Tin Giảng Viên</a>
...
<?php
    ...
    $sql = "SELECT tblichgiangday.*, tbmonhoc.tenmon, tbmonhoc.sotinchi FROM tblichgiangday
    LEFT JOIN tbmonhoc ON tblichgiangday.mamon = tbmonhoc.mamon
    WHERE tblichgiangday.magv = '$username';";      
